...
/* Something to have fun, kids! *///////////////////////////////////////////////////////////
	...
	function shineyellow_replace($content){
		...
		$flvCode = <<<EOT
				...
				<div id='player%DURATION%%HREF%'>You must have <a href="http://get.adobe.com/flashplayer">the Adobe Flash Player</a> installed to view this player.</div>
				<script type='text/javascript'>
					...
					{
						'id': 'player%DURATION%%HREF%',
						'name': 'player%DURATION%%HREF%'
					};
					swfobject.embedSWF('%PLAYER%', 'player%DURATION%%HREF%', '%WIDTH%', '%HEIGHT%', '9', false, flashvars, params, attributes);
				</script>
EOT;
